...
const Acanceledevents = () => {
  ...
  useEffect(() => {
    api.get('/api/admin/canceledEvents', {
      headers: {
  ...
  const handleDenyClick = (eventId) => {
    api.delete(`/api/admin/event/${eventId}`, 
    ...
    <div className="adashmmain">
      ...
      <div className="aeventcon">
        <div className="aeventtitlecon">
          <button onClick={() => navigate('/admin/SHRA/cancelled-events')}>BACK</button>
                ...
                <tr key={event._id} className='eventdetail'>
                  ...
                  <td>
                    <div className='eventbuttonstr'>
                      ...
                      <div className="eadeny" onClick={() => handleDenyClick(event._id)}>DELETE</div>
